...
load ANL_SHRU1_bigfreqs.mat
t=timestamp_num_spectro; % just straight up add them all i have NO IDEA what folder its is in
...
freq_array = [6 10 20 30];

for freq_ind = 1:4
ff=freq_array(freq_ind);
...
savestring = ['spatial_cor_results_interp_new_shru1_50Hz_' num2str(f1(ff)) '_' num2str(f2(ff)) '.mat']

save(savestring,'corr_spa_ave2','corr_spa_ave2_far','date_loop','f1','f2','latitude','longitude','SPL_ANL_ave2','SPL_ANL_ave2_far')
