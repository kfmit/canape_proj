...
%%%%% and with nohup
%%% nohup /usr/local/bin/matlab -nodisplay -nosplash -r a_compute_PSD_long > matlab_nohup_long.out &
...
nFFT_sec= 1*60; % short window, in seconds
nIntegWin_sec= 1*60*60; % long window, in seconds
...
nmax_IntegWin_per_DataFile = 1;% Max number of IntegWin per data files
