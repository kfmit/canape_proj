...
%     sp50 = scatterm(maxcorr_lat50(3:end),maxcorr_lon50(3:end),size50(3:end),maxcorr_val50(3:end),'o');
    sp300 = scatterm(maxcorr_lat300(3:end),maxcorr_lon300(3:end),size300(3:end),maxcorr_val300(3:end),'filled','MarkerEdgeColor','g');
    sp500 = scatterm(maxcorr_lat500(3:end),maxcorr_lon500(3:end),size500(3:end),maxcorr_val500(3:end),'filled','MarkerEdgeColor','b');
    sp1000 = scatterm(maxcorr_lat1000(3:end),maxcorr_lon1000(3:end),size1000(3:end),maxcorr_val1000(3:end),'filled','MarkerEdgeColor','c');
    sp1500 = scatterm(maxcorr_lat1500(3:end),maxcorr_lon1500(3:end),size1500(3:end),maxcorr_val1500(3:end),'filled','MarkerEdgeColor','m');
...
scatter(start_date_vec(3:end),dist300(3:end)/1000,size300(3:end),maxcorr_val300(3:end),'filled','MarkerEdgeColor','g','LineWidth',2)
scatter(start_date_vec(3:end),dist500(3:end)/1000,size300(3:end),maxcorr_val500(3:end),'filled','MarkerEdgeColor','b','LineWidth',2)
scatter(start_date_vec(3:end),dist1000(3:end)/1000,size300(3:end),maxcorr_val1000(3:end),'filled','MarkerEdgeColor','c','LineWidth',2)
scatter(start_date_vec(3:end),dist1500(3:end)/1000,size300(3:end),maxcorr_val1500(3:end),'filled','MarkerEdgeColor','m','LineWidth',2)
datetick('x',1)
ylabel('Distance (km)')
...
scatter(start_date_vec(3:end),dist300(3:end)/1000,size300(3:end),maxcorr_val300(3:end),'o','filled','MarkerEdgeColor','g','LineWidth',2)
scatter(start_date_vec(3:end),dist500(3:end)/1000,size300(3:end),maxcorr_val500(3:end),'s','filled','MarkerEdgeColor','b','LineWidth',2)
scatter(start_date_vec(3:end),dist1000(3:end)/1000,size300(3:end),maxcorr_val1000(3:end),'d','filled','MarkerEdgeColor','c','LineWidth',2)
scatter(start_date_vec(3:end),dist1500(3:end)/1000,size300(3:end),maxcorr_val1500(3:end),'p','filled','MarkerEdgeColor','m','LineWidth',2)
