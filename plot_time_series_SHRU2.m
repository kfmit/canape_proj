...
T = readtable('auxData_SHRU2/variables_ASI-SSMI_SHRU2.csv');
timestamp_num_env=datenum(num2str(T.timestamp),'yyyymmddHHMMSS');

T2= readtable('auxData_SHRU2/variables_ECMWF_SHRU2.csv');
timestamp_num_ecmwf=datenum(num2str(T2.timestamp),'yyyymmddHHMMSS');

T3= readtable('auxData_SHRU2/variables_SMOS_SHRU2.csv');
timestamp_num_smos=datenum(num2str(T3.timestamp),'yyyymmddHHMMSS');

T4= readtable('auxData_SHRU2/variables_temp_SHRU2.csv');
...
p6=subplot(616);
plot(timestamp_num_temp, T4.T2045, timestamp_num_temp, T4.T2074, timestamp_num_temp, T4.sbe3123)
